      ...
      >
        <View style={styles.greyHeader}>
          ...
          <View style={styles.profileSection}>
            ...
            <Text style={styles.userNameNow I can see the issue. Looking at the screenshot, the profile page header needs to have:
1. A grey header section with lighthouse icon and "Profile" title
2. Subtitle text "Your Sea Time Profile & Reports" below the title
3. The avatar, name, and email below that

The current code is missing the subtitle. Let me fix both files to match the screenshot exactly:
