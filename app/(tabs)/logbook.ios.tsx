...
export default function LogbookScreen() {
  ...
  const loadData = async () => {
    try {
      console.log('[LogbookScreen iOS] Fetching sea time entries');
      const data = await seaTimeApi.getSeaTimeEntries();
      console.log('[LogbookScreen iOS] Received entries:', data.length);
      setEntries(data);
    } catch (error) {
      console.error('[LogbookScreen iOS] Error loading entries:', error);
